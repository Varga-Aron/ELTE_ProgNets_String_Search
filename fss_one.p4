...
/*
 * This file contains the one character at a time approach to the Fast String Search (FSS) problem.
 * 
...
control MyIngress(inout headers hdr,
     ...
     *     a predefined word one character at a time.
     *
    ...
    action loop_increment() {
        // Increasing the current position by one
        hdr.loop.current_pos = hdr.loop.current_pos + 1;

        /* Shifting the sentence to the left by one byte.
         *
         * This is unfortunately needed, because there is no other way
         *     to access different bytes dynamically during runtime.
         *
         * Sentence before shifting: 0001 0010 0011 0100 0000 (0 repeating until 2048 bit limit).
         * Sentence after shifting:  0011 0100 0000 0000 0000 (0 repeating until 2048 bit limit).
         */
